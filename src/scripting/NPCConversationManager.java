...
//    }
    ...
    public int gainGachaponItem(int id, int quantity, final String msg) {
        try {
            ...
            if (rareness > 0) {
                World.Broadcast.broadcastMessage(CWvsContext.getGachaponMega(c.getPlayer().getName(), " : got a(n)", c.getChannel(), item, (byte) 2, "From Gachapon"));
            }
    ...
    public int useNebuliteGachapon() {
        try {
            ...
            if (grade >= 3 && grade != 5) {
                World.Broadcast.broadcastMessage(CWvsContext.getGachaponMega(c.getPlayer().getName(), " : got a(n)", c.getChannel(), item, (byte) 2, "Nebulite"));
            }
