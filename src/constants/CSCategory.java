...
public enum CSCategory {
    ...
    CAT1_2(1010200, "Discounted", 2, CSFlag.NORMAL.getValue(), 0),
    CAT1_3(1010300, "Limited Time Specials", 2, CSFlag.NORMAL.getValue(), 0),
    CAT1_4(1010400, "Limited Quantity", 2, CSFlag.NORMAL.getValue(), 0),
    CAT2(1020000, "Time Savers", 1, CSFlag.NORMAL.getValue(), 0),
    CAT2_1(1020100, "Teleport Rocks", 2, CSFlag.NORMAL.getValue(), 0),
    CAT2_2(1020100, "Item Stores", 2, CSFlag.NORMAL.getValue(), 0),
    CAT2_3(1020100, "Quest Helpers", 2, CSFlag.NORMAL.getValue(), 0),
    CAT2_4(1020100, "Packages", 2, CSFlag.NORMAL.getValue(), 1),
    ...
    CAT4_2(1040200, "Upgrade Slots", 2, CSFlag.NORMAL.getValue(), 0),
    CAT4_3(1040300, "Trade", 2, CSFlag.NORMAL.getValue(), 0),
    CAT4_4(1040400, "Other", 2, CSFlag.NORMAL.getValue(), 0),
    CAT4_4_1(1040401, "Item Tag", 3, CSFlag.NORMAL.getValue(), 0),
    CAT4_4_2(1040402, "Item Guards", 3, CSFlag.NORMAL.getValue(), 0),
    CAT4_5(1040500, "Packages", 2, CSFlag.NORMAL.getValue(), 1),
    ...
    CAT6_2(1060100, "Hat", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_1(1060101, "Full Head Cover", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_2(1060102, "Beanies", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_3(1060103, "Hairpin", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_4(1060104, "Hairband", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_5(1060105, "Full Brim Hat", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_6(1060106, "Caps", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_2_7(1060107, "Other", 3, CSFlag.NORMAL.getValue(), 0),
    ...
    CAT6_10(1061000, "Ring", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_10_1(1061001, "Stats", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_10_2(1061002, "Friendship", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_10_3(1061003, "Label", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_10_4(1061004, "Quote", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_10_5(1061005, "Solo", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_11(1061100, "Cape", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_12(1061200, "Packages", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_13(1061300, "Transparent", 2, CSFlag.NORMAL.getValue(), 0),
    ...
    CAT10_2(1100100, "Messengers", 2, CSFlag.NORMAL.getValue(), 0),
    CAT10_3(1100200, "Guild Forum Emoticons", 2, CSFlag.NORMAL.getValue(), 0),
    CAT10_4(1100200, "Weather Effects", 2, CSFlag.NORMAL.getValue(), 0),
    CAT10_4_1(1100200, "Stats", 3, CSFlag.NORMAL.getValue(), 0),
    CAT10_4_2(1100200, "Non-Stats", 3, CSFlag.NORMAL.getValue(), 0),
    CAT11(1110000, "Monster Life", 1, CSFlag.NEW.getValue(), 0),
    CAT11_1(1110100, "Incubators", 2, CSFlag.NORMAL.getValue(), 0);
